...
tiff("../FigESM6_S9.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
...
tiff("../FigESM6_S10.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S11.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S12.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S13.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S14.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S15.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM6_S16.tiff", width = 12, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfrow = c(4, 5), mar = c(6, 6, 0, 0))
...
tiff("../FigESM5_S3.tiff", width = 7, height = 10, units = "in",
  res = 500, compression = "jpeg")          
...
tiff("../FigESM5_S4.tiff", width = 12, height = 5, units = "in",
  res = 500, compression = "jpeg")          
...
# Residual Variances
######################
tiff("../FigESM5_S5.tiff", width = 5, height = 10, units = "in",
  res = 500, compression = "jpeg")          
...
tiff("../FigESM5_S6.tiff", width = 7, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfcol = c(4, 2), oma = c(1, 7, 4, 0),
  mar = c(4.5,4.6,3,1.5), mgp = c(2.5, 1, 0), cex.lab = 1.55, cex.axis = 1.25)    
...
tiff("../FigESM5_S7.tiff", width = 12, height = 5, units = "in",
  res = 500, compression = "jpeg")          
par(mfcol = c(2, 4), oma = c(1, 7, 4, 0),
  mar = c(4.5,4.6,3,1.5), mgp = c(2.5, 1, 0), cex.lab = 1.55, cex.axis = 1.25)    
...
# Residual Variances
######################
tiff("../FigESM5_S8.tiff", width = 5, height = 10, units = "in",
  res = 500, compression = "jpeg")          
par(mfcol = c(4, 1), oma = c(1, 7, 4, 0),
  mar = c(4.5,4.6,3,1), mgp = c(2.5, 1, 0), cex.lab = 1.55, cex.axis = 1.25)    
